...
➡️ Plusieurs personnes peuvent signer un document

**Mapping deja_signes :** `<hashdoc, Mapping <addr, bool>>`
➡️ Verification en O(1) qu'une personne a déjà signé ou non :
Verifie que personne ne signe deux fois un document → Evite pollution de la blockchain et faussement du compte
